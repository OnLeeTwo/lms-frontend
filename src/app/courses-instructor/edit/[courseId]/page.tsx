            ...
            <div className="p-8 flex-1">
                <header className="mb-8">
                    ...
                    <div className="flex justify-between items-start">
                        <h1 className="text-3xl font-bold">Edit Course with ID: {courseId}</h1>
                ...
                <div className="grid gap-6">
                    <Card className="p-6">
                        <div className="mb-6">
                            ...
                            <Input id="title" value={mockCourse.title} onChange={(e) => setTitle(e.target.value)} placeholder="Enter course title" className="mt-1" />
                        </div>

                        <div className="mb-6">
                            <Label htmlFor="description">Course Description</Label>
                            <Input id="description" value={mockCourse.description} onChange={(e) => setDescription(e.target.value)} placeholder="Enter course description" className="mt-1" />
                        </div>

                        <div className="mb-6">
                            <Label htmlFor="category">Course Category</Label>
                            <Input id="category" value={mockCourse.category} onChange={(e) => setCategory(e.target.value)} placeholder="Enter course category" className="mt-1" />
                        </div>
                    </Card>
