      ...
      <div className="flex bg-background">
        ...
        <div className="flex flex-col items-center justify-center min-h-screen flex-grow">
          ...
          <p className="text-gray-600 mt-4">
            Please complete the assessment to view your submission.
          </p>
        </div>
      </div>
    );
              ...
              results.questions.map((q: any, index: number) => (
                <div key={index} className="mb-4">
                  ...
                  <p className="text-gray-700">
                    Your Answer:{" "}
                    <span className="font-semibold">{q.selectedOption}</span>
                  </p>
                  <p className="text-gray-700">
                    Correct Answer:{" "}
                    <span className="font-semibold">{q.correctOption}</span>
                  </p>
                </div>
              ))
            : // Render for essay
